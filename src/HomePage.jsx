    ...
    <div className="flex justify-center">
      <div className="flex flex-wrap justify-center gap-6 items-center">
        ...
        <button
          ...
          className="px-6 py-3 backdrop-blur-md bg-white/10 border border-white/20 text-white text-sm font-medium rounded-xl transition-all duration-300 hover:bg-white/20 hover:shadow-md shadow-white/10"
        >
          Meet Our Team →
        </button>
      </div>
